...
"MPE_DL_Train": ["DLModelTrain_Eval_Train","PE2DL_all_Train","PE2DL_FG_Train","ViewScoresDL_w_AL_Train","Model_Stats"], #to do: make these into one stat table out"PE1DL_all_Train","PE1DL_FG_Train"], #Training: assumes test split sourced from different data than FGs

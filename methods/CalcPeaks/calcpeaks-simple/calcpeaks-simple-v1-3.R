...
args="D:/Cache/522267/376726 D:/Cache/522267/376726/617960  calcpeaks-simple-v1-3"
...
min_mod = unique(data$modified)[which.min(as.POSIXct(unique(data$modified)))]

data_held_out_status = FALSE

if(length(unique(data$modified)) > 1){
  data_held_out = data[-which(data$modified==min_mod),]
  data = data[which(data$modified==min_mod),]

#too clunky to make this a behavior in the normal method. 
#forked from methods\pgpamdb-default-compare-publish\pgpamdb-default-compare-publish-v1-10.R
...
args="C:/Cache/953148/323687/43703/193985/152748 C:/Cache/953148/323687/43703/222397 C:/Cache/953148/323687/43703/193985/152748/905773 n 99 self pgpamdb-fork-sophia-hardcode-v1-0"
...
#HARDCODE character replace (will be character if shorthand is used, numeric otherwise: 
if(class(EditData$signal_code)=="character"){
  EditData[which(EditData$signal_code=="d"),"signal_code"]='15'
  EditData[which(EditData$signal_code=="w"),"signal_code"]='12'
  EditData[which(EditData$signal_code=="t"),"signal_code"]='45'
  EditData[which(EditData$signal_code=="y"),"signal_code"]='46'
  EditData$signal_code = as.integer(EditData$signal_code)
}

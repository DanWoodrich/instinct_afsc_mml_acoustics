args<-"C:/Apps/INSTINCT/Cache/462670/93924 C:/Apps/INSTINCT/Cache/788834/552671/270854/49163 C:/Apps/INSTINCT/Cache/788834/552671/270854/49163/684300  pe1dl-simple-v1-0"
...
for(k in 1:length(unique(data$FGID))){
  ...
  focal_FG = FG[which(FG$Name==unique(data$FGID)[k]),]
